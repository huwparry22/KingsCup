...
|-----------|----------|----------|
| Architecture & scope | Danny | Project structure, SignalR design, game state architecture, trade-offs |
| Blazor UI & components | Rusty | Razor components, CSS, card rendering, game board, lobby UI |
| Backend & game logic | Linus | SignalR hub, game state management, room codes, card deck logic, APIs |
| Code review | Danny | Review PRs, check quality, suggest improvements |
| Testing | Basher | Write tests, find edge cases, verify multiplayer scenarios |
